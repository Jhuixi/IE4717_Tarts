    ...
    <div class="wrapper">
        <div class="background_box">
          <nav class="breadcrumb">
            ...
            <div class="row1">
                <div class="image_box">
                    <img src="images/9autumn.jpg" id="product_imgs">
                </div>
                <form action="insert_order.php" method="POST">
                    <div class="text_box">
                        <div class="text_content">
                            <h1>Autumn's Breeze</h1>
                            <h4>$8.20</h4>
                            <p>Indulge in the rich, nutty goodness of our chestnut tart. This enticing dessert
                        ...
                        <div class="box_addtocart">
                            ...
                            <input type="hidden" name="productname" id="productname" value="Autumn's Breeze">
